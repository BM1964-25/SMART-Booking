...
export function AdminNav() {
  return (
    <nav className="mt-6 flex flex-wrap gap-3 text-sm">
      ...
      <Link href="/admin/profiles" className="rounded-md border border-slate-300 bg-white px-4 py-2 font-semibold text-slate-800 hover:border-brand-500 hover:text-brand-600">
        Profile
      </Link>
    </nav>
  );
